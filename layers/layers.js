...
lyr_1868japan_0.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', '国名': '国名', });
lyr_2023Japan22023japan2_1.set('fieldAliases', {'fid': 'fid', 'JCODE': 'JCODE', 'KEN': 'KEN', });
lyr_1868japan_0.set('fieldImages', {'fid': '', 'OBJECTID': '', '国名': '', });
lyr_2023Japan22023japan2_1.set('fieldImages', {'fid': 'TextEdit', 'JCODE': 'TextEdit', 'KEN': 'TextEdit', });
lyr_1868japan_0.set('fieldLabels', {'fid': 'no label', 'OBJECTID': 'no label', '国名': 'no label', });
lyr_2023Japan22023japan2_1.set('fieldLabels', {'fid': 'no label', 'JCODE': 'no label', 'KEN': 'no label', });
